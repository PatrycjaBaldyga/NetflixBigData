...
# ./project_files HDFS directory
hadoop fs -copyFromLocal *.jar project_files
hadoop fs -copyFromLocal *.hql project_files

echo " "
echo ">>>> launching the MapReduce job - processing (2)"
hadoop jar prizedataratings15.jar PrizeDataRatings -D mapred.textoutputformat.separator="," input/datasource1 output_mr3
